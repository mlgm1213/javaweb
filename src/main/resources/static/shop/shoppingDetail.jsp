    ...
    <section>
        <div class="main">
            <ul class="menu">
                ...
                <li><span class="red_dot"></span><a href="/shop/findByType?type=1&page=1">上衣</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=1&page=1">下装</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=1&page=1">连衣裙</a><span
                        class="right_arrow"></span></li>
                <li><span class="title">男装</span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=2&page=1">T恤</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=2&page=1">衬衫</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=2&page=1">短裤</a><span
                        class="right_arrow"></span></li>
                <li><span class="title">童装</span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=3&page=1">上衣</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=3&page=1">裤子</a><span
                        class="right_arrow"></span></li>
                <li><span class="title">运动</span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=4&page=1">运动衫</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=4&page=1">运动裤</a><span
                        class="right_arrow"></span></li>
                <li><span class="red_dot"></span><a href="/shop/findByType?type=4&page=1">跑步鞋</a><span
                        class="right_arrow"></span></li>
            </ul>
            <!--购物分类end-->
            <!--中间区 start-->
            <div class="middle">
                ...
                <div class="left_pic">
                    <div><img src="images/shopshow/${requestScope.gpicture}" width="400" height="400"></div>
                    <ul class="small_piclist">
                        <li><img src="images/showdetail/dd1.jpg"></li>
                        <li><img src="images/showdetail/dd2.jpg"></li>
                        <li><img src="images/showdetail/dd3.jpg"></li>
                        <li><img src="images/showdetail/dd4.jpg"></li>
                        <li><img src="images/showdetail/dd5.jpg"></li>
                    </ul>
                </div>
                <div class="right">
                    <h1 class="font16">
                    ...
                    <img src="images/showdetail/cnm.jpg"/>
                </div>
                <form action="/order/placeOrder">
                    <input name="order" type="submit" value="立即购买" style="width: 110px; height: 40px; background-color: #ff9c01; color: #ffffff; border-color: #ffffff"/>
                </form>
                <form action="/order/addCart">
                    <input name="like" type="submit" value="加入购物车" style="width: 140px; height: 40px; background-color: #ff6600; color: #ffffff; border-color: #ffffff"/>
                </form>
                <div class="clear"></div>
                <ul class="tab">
                ...
                <article class="tab_content1">
                    ...
                    <section><img src="images/showdetail/detail1.jpg"> <img src="images/showdetail/detail2.jpg"> <img
                            src="images/showdetail/detail3.jpg" class="img_border"> <img
                            src="images/showdetail/detail4.jpg" class="img_border"> <img
                            src="images/showdetail/detail5.jpg" class="img_border"><img
